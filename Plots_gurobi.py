...
def plot_operation_vs_time(df):
        ...
        sns.scatterplot(x=df.time[time_start:time_stop], y=df.Electrcitiy_available[time_start:time_stop], ax=ax2,
                       color=color_x_el_available)
        ax1.set_ylabel('H2 produced [kg/h]', color=color_h2)
        ax1.set_xlabel('Time [h]')
        ax1.set_title('Dispatch for the 1st of January', fontdict = { 'fontsize': 14, 'verticalalignment': 'center', 'horizontalalignment': 'center'})
